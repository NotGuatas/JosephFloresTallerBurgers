...
namespace JosephFloresCodeFirst.Controllers
{
    public class BurgersController : Controller
    {
        private readonly JosephFloresCodeFirstContext _context;

        public BurgersController(JosephFloresCodeFirstContext context)
        {
            _context = context;
        }
